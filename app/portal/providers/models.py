...
class PoliticalRegion(models.Model):
    ...
    regionType = models.CharField(choices=REGION_TYPE_CHOICES, default='State', verbose_name="Type of political region")
...
class PoliticalSubregion(models.Model):
    ...
    region = models.ForeignKey(PoliticalRegion)
...
class Distributor(models.Model):
    ...
    primaryContactFirstName = models.CharField(max_legnth=100, blank=True, null=True, default=None, verbose_name="Primary contact's first name")
    primaryContactLastName = models.CharField(max_legnth=100, blank=True, null=True, default=None, verbose_name="Primary contact's last name")
    ...
    businessAddressState = models.ForeignKey(PoliticalRegion, blank=True, null=True, default=None, verbose_name="Business Address State")
...
class Provider(models.Model):
    ...
    businessAddressState = models.ForeignKey(PoliticalRegion, verbose_name="Business Address State")
    ...
    physicalAddressState = models.ForeignKey(PoliticalRegion, blank=True, null=True, default=None, verbose_name="Physical Address State")
    ...
    regionalAvailability = models.models.ManyToManyField(PoliticalSubregion)
    orderMinimum = MoneyField(max_digits=8, decimal_places=2, default_currency='USD', null=True, blank=True, defualt=None)
    deliveryMinimum = MoneyField(max_digits=8, decimal_places=2, default_currency='USD', null=True, blank=True, defualt=None)
...
class CapacityMeasurement(models.Model):
    ...
    measurementType = models.CharField(choices=TYPE_CHOICES)
...
class ProductCategory(models.Model):
    ...
    capacityMeasurement = models.ForeignKey(CapacityMeasurement)
...
class Product(models.Model):
    ...
    image = models.ImageField(null=True, blank=True, defualt=None)
    description = models.TextField(null=True, blank=True, defualt=None)
