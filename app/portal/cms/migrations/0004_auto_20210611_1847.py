...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='resultspage',
            name='filter_advice',
            field=wagtail.fields.RichTextField(blank=True, default='<p>Try removing filters to see more results</p>', help_text='Helpful advice for users confused by their results'),
        ),
        migrations.AddField(
            model_name='resultspage',
